 ...
 *  <li>Manually make it work, remove verbose and redundant parts.
 * </ul>
 */
...
public class Game {
	...
	public List<Game.Inning> getInning() { return this.inning; }
	...
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "top", "bottom" })
	public static class Inning {
		...
		public Game.Inning.HalfInning getTop() { return top; }
		public Game.Inning.HalfInning getBottom() { return bottom; }
		public Integer getNum() { return num; }
		public String getAwayTeam() { return awayTeam; }
		public String getNext() { return next; }

		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "atbat" })
		public static class HalfInning {

			@XmlElement(required = true) protected List<Game.Inning.HalfInning.Atbat> atbat;

			public List<Game.Inning.HalfInning.Atbat> getAtbat() { return this.atbat; }

			@XmlAccessorType(XmlAccessType.FIELD)
			@XmlType(name = "", propOrder = { "pitch" })
			public static class Atbat {

				@XmlElement(required = true) protected List<Game.Inning.HalfInning.Atbat.Pitch> pitch;
				@XmlAttribute protected Integer num;
				...
				public List<Game.Inning.HalfInning.Atbat.Pitch> getPitch() { return this.pitch; }
				public Integer getNum() { return num; }
